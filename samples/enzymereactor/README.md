...
The EnzymeReactor_Sample.ink file is a place to start to train a brain on a part of this process. The Sample is an example of a multi-concept
...
After you get your sim created, paste the package statement into the Simulator definition on line 71.  
...
The below sections explain the inkling in more detail.
...
Bonsai can of course only use one concept output, and in this particular example two of the concepts use some of the same actions (i.e. those
...
Too combat this domain randomisaiton is used. A range of starting points for certain variables is include alongside the initial conditions file. 
